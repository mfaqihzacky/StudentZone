...
@section('container')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    <h4>{{ $user->name }}</h4>
                                    <p class="text-secondary mb-1">{{ $user->isAdmin === true ? 'Mahasiswa' : 'Admin' }}</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container text-center">
                                        <div class="row align-items-start">
                                            <div class="col">
                                            @foreach ($matkul as $m)
                                                <label>{{ $m->namaMatKul }}</label>
                                                <input type="number" step="0.01"></input>
                                            @endforeach
                                            </div>
                                            <div class="col">
                                            </div>
                                            {{-- <a class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editModal">Save</a> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @include('Profile.editPasswordModal')
