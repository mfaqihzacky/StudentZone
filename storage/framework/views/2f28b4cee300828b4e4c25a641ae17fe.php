<form method="post" action="/jadwal" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <input type="text" value="<?php echo e($matkul->id); ?>" name="matkulId" id="matkulId" hidden>
    <div class="m-3">
...
<?php /**PATH D:\UNIVERSITASSEBELASMARET\Software\laragon\www\StudentZone\resources\views/Menu/MataKuliah/editJadwal/editJadwalForm.blade.php ENDPATH**/ ?>