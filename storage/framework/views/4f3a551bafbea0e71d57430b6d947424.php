<div class="modal fade" id="editModal<?php echo e($materi->id); ?>" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="/materi/<?php echo e($materi->id); ?>" enctype="multipart/form-data">
                ...
                <div class="m-3">
                    ...
                    <div class="form-group">
                        ...
                        name="judul" id="judul" value="<?php echo e(old('', $materi->judul)); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-floating">
                            ...
                            style="height: 100px"
                            ><?php echo e(old('', $materi->deskripsi)); ?></textarea>
...
</div><?php /**PATH D:\UNIVERSITASSEBELASMARET\Software\laragon\www\StudentZone\resources\views/Menu/Materi/editModal.blade.php ENDPATH**/ ?>